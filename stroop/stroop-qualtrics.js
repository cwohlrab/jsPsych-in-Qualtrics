...
forked from kywch/jsPsych-in-Qualtrics
0
013
Code
Pull requests
...
Insights
Settings
jsPsych-in-Qualtrics/n-back/stroop_main.js /
@cwohlrab
cwohlrab Create stroop_main.js
Latest commit 94c2af1 31 seconds ago
 History
 1 contributor
125 lines (110 sloc)  3.83 KB
...
var n_back_set = ['Test', 'Hello', 'Good', 'Bad', 'Yes', 'No'];
var sequence = [];
...
var instructions_1 = {
  ...
  stimulus: '<div style="width: 800px;">'+
    '<p>This experiment will test your attention.</p>'+
    '</div>',
  choices: ["Continue"]
}
